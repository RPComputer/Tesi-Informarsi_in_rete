'''
Nome:
Estrattore degli articoli a raccolta singola

Obiettivo:
Estrarre dal codice HTML delle notizie gli articoli una alla volta dal database
...
while True:
	fetcherror = 0
	#Caricamento di una notizia per volta al fine di non occupare troppa RAM, gestione degli errori per riconnessione
	try:
